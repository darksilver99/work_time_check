...
class CompanyManageListPageWidget extends StatefulWidget {
  ...
  @override
  State<CompanyManageListPageWidget> createState() =>
      _CompanyManageListPageWidgetState();
}

class _CompanyManageListPageWidgetState
    extends State<CompanyManageListPageWidget> {
  late CompanyManageListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanyManageListPageModel());
  }
                              ...
                              child: StreamBuilder<CompanyListRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      await containerCompanyListRecord.reference
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              TotalWaitingEmployeeViewWidget(
                                                key: Key(
                                                    'Keyuf4_${listViewIndex}_of_${listViewAdminListRecordList.length}'),
                                                companyParameter:
                                                    containerCompanyListRecord,
                                              ),
                                              Icon(
