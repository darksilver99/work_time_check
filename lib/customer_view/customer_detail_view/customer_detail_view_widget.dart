...
export 'customer_detail_view_model.dart';

class CustomerDetailViewWidget extends StatefulWidget {
  const CustomerDetailViewWidget({
    super.key,
  ...
  @override
  State<CustomerDetailViewWidget> createState() =>
      _CustomerDetailViewWidgetState();
}

class _CustomerDetailViewWidgetState extends State<CustomerDetailViewWidget> {
  late CustomerDetailViewModel _model;
