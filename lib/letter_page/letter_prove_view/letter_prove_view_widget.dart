...
import 'letter_prove_view_model.dart';
export 'letter_prove_view_model.dart';

class LetterProveViewWidget extends StatefulWidget {
  const LetterProveViewWidget({
    super.key,
  ...
  @override
  State<LetterProveViewWidget> createState() => _LetterProveViewWidgetState();
}

class _LetterProveViewWidgetState extends State<LetterProveViewWidget>
    with TickerProviderStateMixin {
  late LetterProveViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LetterProveViewModel());
