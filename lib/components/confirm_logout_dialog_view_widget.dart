...
class _ConfirmLogoutDialogViewWidgetState
    extends State<ConfirmLogoutDialogViewWidget> {
  late ConfirmLogoutDialogViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmLogoutDialogViewModel());
  }
